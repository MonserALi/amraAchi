      ...
      <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="user-profile-nav">
            <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="User" class="user-avatar-nav">
            <div class="user-info-nav">
              <h4><span class="lang-text en">Rahim Khan</span><span class="lang-text bn">রহিম খান</span></h4>
  ...
  <main class="main-content" id="mainContent">
    ...
    <div class="content-section">
      <div class="section-header">
        <h2 class="section-title">
          <i class="fas fa-history"></i>
          <span class="lang-text en">Recent Trips</span><span class="lang-text bn">সাম্প্রতিক ট্রিপ</span>
        </h2>
        <a href="#" class="section-link">
          <span class="lang-text en">View All</span>
          <span class="lang-text bn">সব দেখুন</span>
